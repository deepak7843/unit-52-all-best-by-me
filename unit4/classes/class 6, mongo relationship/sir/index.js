...
const connectDB = () => {
  return mongoose.connect(
    ...
    "mongodb+srv://deepak123:13549Aa@cluster0.aqkfd.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"
  );
};

                                                                                                            //whatever you do with mongoose connectDB will return promise
...
const userSchema = new mongoose.Schema(
  {
    ...
    password: { type: String, required: true }, //here I can give min,max length of password  @27:30
  },
  { 
    versionKey: false,
...
// Step 2 : creating the user model @27:48 
...
const postSchema = new mongoose.Schema(
  {
    ...
    userId: {
      type: mongoose.Schema.Types.ObjectId,                                                               //.......    .Types??
      ref: "user",
      required: true, //true, because post can't exist without user
    },
  },
